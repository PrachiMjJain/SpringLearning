...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Rap god", 5.0);
        album.addSong("Not Afraid", 3.3);
        album.addSong("Lose Yourself", 5.2);
                ...
                switch(action){
                    ...
                    case 1:
                        ...
                        if(listIterator.hasNext()){
                            ...
                            System.out.println("no song avialble , reached to the end of the list");
                            forward = false;
                        }
                        break;
                    case 2:
                    ...
                    case 3:
                        if(forward){
                            if(listIterator.hasPrevious()){
                                ...
                                System.out.print("we are at the start of this list");
                            }
